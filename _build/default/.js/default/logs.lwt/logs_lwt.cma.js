...
//# unitInfo: Provides: Logs_lwt
//# unitInfo: Requires: Logs, Lwt
(function
  (globalThis){
   "use strict";
   var runtime = globalThis.jsoo_runtime, cst = "", cst_a = "@[%a@]";
   ...
   var
    ...
    _a_ = [0, [18, [1, [0, 0, cst]], [15, [17, 0, 0]]], cst_a];
   function kmsg(k, opt, level, msgf){
    ...
    if(level$0 < level){
     ...
     else if(2 === level) caml_call1(Logs[26], 0);
    ...
    var
     ...
     unblock = match$0[2],
     ret = match$0[1];
    function k$0(param){return caml_call2(Lwt[6], ret, k);}
    function over(param){return caml_call2(Lwt[52], unblock, 0);}
   ...
   function on_error(src, opt, header, tags, pp, use, t){
    ...
    return caml_call1(caml_call1(Lwt[6], t), _h_);
   }
    ...
    function _g_(param){
     ...
     return kmsg
             (use,
              ...
              level,
              function(m){
               return caml_call5(m, header, tags, _b_, Logs[27], e);
              });
    }
    return caml_call1(caml_call1(Lwt[6], t), _g_);
   }
   function src_log(src){
    function msg$0(level, msgf){return msg([0, src], level, msgf);}
    function kmsg$0(over, k, level, msgf){
     return kmsg(k, [0, src], level, msgf);
    }
...
//# sourceMappingURL=data:application/json;base64,
